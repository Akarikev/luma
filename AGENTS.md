...
- Regenerate tray/bundle mascot PNGs by running `python3 scripts/generate_luma_icons.py` from the repo root when changing icon art (then refresh `icon.ico` if needed for Windows).
